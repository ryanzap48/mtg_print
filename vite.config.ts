...
export default defineConfig(({ mode }) => {
  // The sitemap, robots.txt and prerenderer are plain Node scripts and read SITE_URL; the app
  // bundle can only see VITE_-prefixed variables. Mirroring one into the other keeps the domain
  // a single setting: without this, canonical URLs and the JSON-LD @ids come out relative.
